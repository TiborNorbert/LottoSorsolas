...
namespace LottoSorsolas
{
    public partial class Form1 : Form
    {
            ...
            for (int i = 0; i < 6; i++)
            {
                for (int j = 0; j < 15; j++)
                {
                    ...
                    uj.Click += (sender, e) =>
                    {
                        ...
                        megjatszot.Text = "Megjátszott ->" + string.Join(", ", jatszott_Szamok);
                    };
        ...
        private void sorsolas_Click(object sender, EventArgs e)
        {
            ...
            nyeroszamok.Text = "Nyerőszámok -> " + string.Join(", ", sorsolt_Szamok);
            ...
            if (talalat == 0)
            {
                talalata.Text = "Találat -> Önnek most nincs találata!";
            }
            else
            {
                talalata.Text = "Találat -> Önnek " + talalat.ToString() + " találata van!";
            }
        }
    }
}
